					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<input id="address" name="address" class="form-control"
								type="text" value="<%=request.getAttribute("address")%>">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-8">
							<input id="city" name="city" class="form-control"
								type="text" value="<%=request.getAttribute("city")%>">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-8">
							<input id="state" name="state" class="form-control"
								type="text" value="<%=request.getAttribute("state")%>">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-8">
							<input id="country" name="country" class="form-control"
								type="text" value="<%=request.getAttribute("country")%>">
						</div>
					</div>
