				...
				<div  class="profile-sidebar">
					...
					<div class="profile-usermenu">
						<ul class="nav">
							...
							<li><a href="GetMyBids.jsp"> <i
									class="glyphicon glyphicon-flag"></i> My Bids
							</a></li>
								...
								<div class="modal-body">
									<form class="form-horizontal" role="form" id="addPostForm" action="AddPost.jsp" method="post">
										<div class="form-group">
											<label class="col-md-3 control-label" for="mobile">Mobile Name:</label>
											<div class="col-md-8">
												<input id="mobile" placeholder="Mobile Name"
													class="form-control" type="text" name="mobile" required>
											</div>
										</div>
										<input type="hidden" name="userid" id="userid"
											value=<%=session.getAttribute("userid")%>></input>
										<div class="form-group">
											<label class="col-md-3 control-label" for="companyName">Company
												Name:</label>
											<div class="col-md-8">
