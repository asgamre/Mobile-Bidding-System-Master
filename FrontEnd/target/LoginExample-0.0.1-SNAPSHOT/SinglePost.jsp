		...
		<div class="container" style="margin-top: 80px;">
			<div class="row">
				...
				<div class="col-md-9 table-responsive">
					<h2 style="font-weight: bold"><%=request.getAttribute("bookname")%></h2>
					<p style="font-size: 16px">
						<span"><span>By:</span><span
							style="color: #3B5998; font-weight: bold"> <%=request.getAttribute("authorname")%></span></span>
						<span><span style="margin-left: 20px;"> Publisher: </span><span
							style="color: #3B5998; font-weight: bold"><%=request.getAttribute("publishername")%></span></span>
